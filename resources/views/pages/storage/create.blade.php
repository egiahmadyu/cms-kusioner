              ...
              <form id="form_tambah" class="needs-validation" novalidate>
                ...
                <div class="row">
                  <div class="col-md-6 col-lg-6 mb-3">
                    ...
                    <input class="form-control" id="number" name="number" placeholder="R/ND-" type="text" readonly>
                  </div>
                  <div class="col-md-6 col-lg-6 mb-3">
                    <label class="form-control-label">Tanggal Nota Dinas: <span class="tx-danger">*</span></label> 
                    <input class="form-control" id="nd_date" name="nd_date" required="" type="date">
                  </div>
                  <div class="col-md-6 col-lg-6 mb-3">
                    <label class="form-control-label">SPRIN: <span class="tx-danger">*</span></label>
                    <input class="form-control" id="sprin" name="sprin" placeholder="Sprin/" required="" type="text">
                  </div>
                  <div class="col-md-6 col-lg-6 mb-3">
                    <div class="row">
                      <div class="col-md-6 col-lg-6">
                        <label class="form-control-label">Tanggal SPRIN: <span class="tx-danger">*</span></label>
                        <input class="form-control" id="sprin_date" name="sprin_date" placeholder="Sprin/" required="" type="date">
                      </div>
                      <div class="col-md-6 col-lg-6">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-lg-6 mb-3">
                    ...
                    <input class="form-control" id="report_number" name="report_number" placeholder="R/LI-" required="" type="text">
                  </div>
                  <div class="col-md-3 col-lg-3 mb-2">
                    <label class="form-control-label">Tanggal Laporan: <span class="tx-danger">*</span></label>
                    <input class="form-control" id="report_date" name="report_date" placeholder="R/LI-" required="" type="date">
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6 col-lg-6 mb-3">
                    <label class="form-control-label">Nama Pelanggar: <span
                      ...
                      placeholder="Nama Pelanggar" required="" type="text">
                  </div>
                  <div class="col-md-6 col-lg-6 mb-3">
                      ...
                      <div class="col">
                        <div class="form-group d-inline-flex align-items-center gap-4">
                          <label class="custom-control custom-checkbox mb-0 d-inline-flex align-items-center gap-2">
                              <input type="radio" class="custom-control-input" id="disiplin" name="jenis_wp" value="1" onchange="disiplinChange(this)" autocomplete="off" required>
                              <span class="custom-control-label">DISIPLIN</span>
                          </label>
                          <label class="custom-control custom-checkbox mb-0 d-inline-flex align-items-center gap-2">
                              <input type="radio" class="custom-control-input" id="kode_etik" name="jenis_wp" value="2" onchange="kodeEtikChange(this)" autocomplete="off" required>
                  ...
                  <div class="col-md-12 col-lg-12 mb-3">
                    <label class="form-control-label">Wujud Perbuatan: <span
                      class="tx-danger">*</span></label> 
                    <select class="form-select select2" data-live-search="true" aria-label="Default select example" name="violation" id="wujud_perbuatan" autocomplete="off" disabled required>
